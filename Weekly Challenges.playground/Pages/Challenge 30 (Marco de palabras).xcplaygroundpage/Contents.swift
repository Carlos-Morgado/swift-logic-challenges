...
/* func frameWords(text:String) {
    let individualWords = text.components(separatedBy: " ")
    print(individualWords)
    for newLines in individualWords {
        print(newLines,terminator: "\n")
    }
}

frameWords(text: "¿Qué te parece el reto?") */
